  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-950 via-gray-900 to-gray-950 text-white flex flex-col items-center justify-start px-4 py-10 gap-8">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-blue-600 hover:bg-blue-500   active:bg-green-700 active:scale-55 text-white font-semibold px-5 py-2.5 rounded-xl w-full transition-all duration-300 ease-linear shadow-md shadow-blue-900/40    hover:shadow-lg hover:shadow-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-400"
        >
          + Add Note
        </button>
      </form>
